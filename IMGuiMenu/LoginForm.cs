...
namespace ProfileApp
{
    public class LoginForm : Form
    {
        ...
        {
            // Simple validation (you can integrate real auth)
            ...
            // Proceed to Main Menu; pass reference to this login form for logout return
            var mainMenu = new MainMenuForm(this, txtUsername.Text.Trim());
            mainMenu.Show();
            Hide();
        }
